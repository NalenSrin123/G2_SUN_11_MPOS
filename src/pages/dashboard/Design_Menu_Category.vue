...
// ── Category data (each item has a unique id) ───────────────────
const categories = ref([
  { id: 1,  name: "Appetizers",    icon: UtensilsCrossed, description: "Small plates and snacks to start the meal, including tapas, bruschetta, and shareable bites", items: 18 },
  { id: 2,  name: "Main Course",   icon: Beef,            description: "Hearty signature dishes, steaks, pasta, and sea-to-table specialties", items: 42 },
  { id: 3,  name: "Desserts",      icon: IceCreamBowl,    description: "Handcrafted sweets, artisanal gelatos, and seasonal fruit selections", items: 12 },
  { id: 4,  name: "Beverages",     icon: Wine,            description: "Craft cocktails, local wines, organic juices, and premium spirits", items: 24 },
  { id: 5,  name: "Lunch Specials",icon: Sandwich,        description: "Daily rotating lunch items available from 11 AM to 3 PM", items: 6 },
  { id: 6,  name: "Soups & Salads",icon: Salad,           description: "Fresh greens and warm broths for a light and healthy start", items: 10 },
  { id: 7,  name: "Breakfast",     icon: Coffee,          description: "Morning favorites served until 11 AM, including eggs, pancakes, and more", items: 14 },
  { id: 8,  name: "Sides",         icon: Soup,            description: "Perfect accompaniments to any main dish", items: 8 },
  { id: 9,  name: "Kids Menu",     icon: Baby,            description: "Smaller portions for younger guests, with fun and healthy options", items: 7 },
  { id: 10, name: "Pizza",         icon: Pizza,           description: "Wood-fired pizzas with house-made dough and fresh toppings", items: 9 },
  { id: 11, name: "Sandwiches",    icon: Sandwich,        description: "Hearty handhelds with artisan bread and premium fillings", items: 11 },
  { id: 12, name: "Specials",      icon: Star,            description: "Chef curated rotating seasonal specials", items: 5 },
]);

// Auto-increment id counter
const nextId = ref(categories.value.length + 1);
...
const handleAddProduct = (newCategory) => {
  categories.value.push({
    ...
    description: newCategory.description || "New category added",
    items: 0,
  });
