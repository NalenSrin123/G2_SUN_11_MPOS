<template>
  <div class="min-h-screen p-8 font-sans">
    ...
    <div class="flex justify-between items-start mb-6">
      ...
      <button
        class="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition"
      >
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
      <div class="border border-gray-400 bg-white rounded-xl p-5">
        <div class="flex justify-between items-start mb-4">
          ...
          <span class="text-sm font-semibold text-emerald-500">+4.2%</span>
        </div>
      ...
      <div class="border border-gray-400 bg-white rounded-xl p-5">
        <div class="flex justify-between items-start mb-4">
          <div
            class="w-10 h-10 bg-gray-200 rounded-xl flex items-center justify-center"
          >
            <TriangleAlert class="w-5 h-5 text-red-700" />
          </div>
          <span class="text-sm font-semibold text-red-400">-2 today</span>
        </div>
        <p class="text-xs text-gray-400 uppercase tracking-widest font-medium">
          Out of Stock
        </p>
      ...
      <div class="border border-gray-400 bg-white rounded-xl p-5">
        <div class="flex justify-between items-start mb-4">
          ...
          <span class="text-xs text-gray-400 font-medium">High Demand</span>
        </div>
        <p class="text-xs text-gray-400 uppercase tracking-widest font-medium">
          Top Selling Item
        </p>
        <p class="text-2xl font-bold text-gray-900 mt-1">Wagyu Ribeye</p>
      </div>
    </div>
    ...
    <div class="border border-gray-400 rounded-xl overflow-hidden">
      ...
      <div class="flex justify-between items-center px-5 py-3 bg-white">
        <div class="flex gap-2">
          <div
            class="flex items-center bg-gray-100 gap-2 border border-gray-400 rounded-lg px-3 py-2"
          >
            ...
            <input
              ...
              class="text-sm text-gray-600 placeholder-gray-400 outline-none w-44"
            />
          </div>
          <button
            class="flex items-center gap-2 border border-gray-400 rounded-lg px-3 py-2 text-sm text-gray-600 hover:bg-gray-50"
          >
      ...
      <table class="w-full border-t border-gray-100">
        <thead>
          <tr class="bg-gray-100 border-t border-gray-400">
            <th
              class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-widest w-[30%]"
            >
              Product Name
            </th>
            <th
              class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-widest w-[20%]"
            >
              Category
            </th>
            <th
              class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-widest w-[15%]"
            >
              Price
            </th>
            <th
            ...
            <th
              class="text-right px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-widest w-[20%]"
            >
              Actions
            </th>
          </tr>
        ...
        <tbody class="bg-white">
          <tr
            ...
            :key="p.sku"
            class="border-t border-b border-gray-400 h-[72px]"
          >
            <td class="px-5 py-4">
              <div class="flex items-center gap-3">
                <img
            ...
            <td class="px-5 py-4 text-sm text-gray-500">{{ p.category }}</td>
            ...
            <td class="px-5 py-4 text-right">
              <div class="flex justify-end gap-3 text-sm text-gray-400">
                ...
                <button
                  class="hover:text-emerald-500 transition-colors flex items-center gap-1"
                >
      ...
      <div
        class="flex justify-between items-center px-5 py-4 border-t border-gray-100 bg-gray-100"
      >
        <button
          @click="page > 1 && page--"
          :disabled="page === 1"
          class="flex items-center gap-1 border border-gray-400 rounded-lg px-4 py-2 text-sm text-gray-500 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition"
        >
    ...
    <div class="fixed bottom-6 right-6">
      <button
        class="w-12 h-12 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl flex items-center justify-center shadow-lg transition"
      >
