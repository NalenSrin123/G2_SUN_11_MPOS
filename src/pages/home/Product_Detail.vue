...
<template>
  <!-- Top Navbar -->
  <div class="fixed top-0 w-full flex z-50 bg-white h-14 items-center justify-between px-4 shadow-sm">
    <i
  ...
  <!-- Main Content -->
  <div class="bg-blue-100/50 mt-14 min-h-screen pb-28">

    <!-- Hero Image -->
    <div class="relative shadow-md h-60 md:h-80 w-full overflow-hidden">
      <img
        class="h-full w-full object-cover"
        src="https://i.pinimg.com/736x/31/9a/05/319a05ad3a2868bd0f42bcdfdb4d17ba.jpg"
        alt="Beef"
      />

      <div class="absolute top-4 right-4 rounded-full text-white px-4 py-1 bg-blue-500 text-sm shadow">
        Steak Beef
      </div>
    </div>
